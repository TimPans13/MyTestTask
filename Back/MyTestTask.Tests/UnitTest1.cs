...
namespace MyTestTask.Tests
{
    public class TaskServiceTests
    {
        ...
        public async Task Get_ValidId_ReturnsContact()
        {
            ...
            var result = await taskService.Get(contactId);
        ...
        public async Task GetAll_ReturnsListOfContacts()
        {
            ...
            {
                new Contact { Name = "John", MobilePhone = "+123", JobTitle = "Developer", BirthDate = DateTime.Parse("1999-01-14") },
                new Contact { Name = "Jane", MobilePhone = "+456", JobTitle = "Manager", BirthDate = DateTime.Parse("1995-11-13") }
            };
        ...
        public async Task Add_ValidContact_ReturnsMappedContact()
        {
            ...
            var result = await taskService.Add(contact);
        ...
        public async Task Delete_ExistingContact_DeletesContact()
        {
            ...
            await taskService.Delete(contactEntity.Id);
        ...
        public async Task Update_ExistingContact_UpdatesContact()
        {
            ...
            await taskService.Update(contactIdToUpdate, updatedContact);
